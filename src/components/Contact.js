...
function Contact() {
  ...
  <p className="mb-4 flex items-start justify-center">
    <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2 mt-1 flex-shrink-0" />
    <span className="text-left">CarXpert, Plot No. 15, A.B.C. Road,<br/>Ahmedabad, Gujarat-Pincode</span>
  </p>
