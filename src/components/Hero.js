...
function Hero() {
  return (
    <section id="hero" className="bg-gray-900 bg-opacity-70 bg-blend-overlay bg-cover bg-center h-screen flex flex-col justify-center items-center text-center text-white px-5" style={{backgroundImage: "url('images/hero1.png')"}} data-aos="fade-in">
